...
def parse_args():
    ...
    parser.add_argument('--checkpoints', type=str, default='checkpoints/<YOUR CHECKPOINT>', help='checkpoint dir')
    parser.add_argument('--datalist', type=str,
                        default=r"<YOUR DATASET>", # Enter FULL path to train *.txt file
                        help='training datalist')
    parser.add_argument('--val_datalist', type=str,
                        default=r"<YOUR DATASET>", # Enter FULL path to validation *.txt file
                        help='validating datalist')
    parser.add_argument('--test_datalist', type=str,
                        default=r"<YOUR DATASET>", # Enter FULL path to test *.txt file
    ...
    #                     help='height for the test/val tensorflow placeholder')
    # parser.add_argument('--width', type=int, default=256,
    #                     help='width for the test/val tensorflow placeholder')
    parser.add_argument('--input_path', type=str, default="",
                        help='input path for testing/validation corrupted images')
    parser.add_argument('--output_path', type=str, default="",
                        help='output path for cnn-processed images')
